...
const STRINGS = {
  en: {
    ...
    'details.sleepingHint': 'Hotel confirmations, check-in details, addresses —',
    ...
    // day by day
    'day.empty': 'Nothing planned yet — add a destination in the Destinations tab.',
    'day.number': 'Day {n}',
    ...
    'attractions.searchError': 'Search is unavailable right now — try again shortly.',
